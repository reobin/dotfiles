---
description: Create a PR for the current branch from commits already made, pushing first if needed.
argument-hint: [optional scope or intent]
allowed-tools: Bash(git status *) Bash(git diff *) Bash(git log *) Bash(git rev-parse *) Bash(git branch *) Bash(git remote *) Bash(git push *) Bash(gh pr create *) Bash(gh repo view *)
---
